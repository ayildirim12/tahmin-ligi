  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-background">
      ...
      <div className="relative flex flex-1 items-center justify-center px-4 py-10">
        <div className="flex w-full max-w-sm flex-col items-center gap-8 rounded-3xl border border-border bg-surface/80 px-8 py-10 text-center shadow-xl backdrop-blur-sm">
